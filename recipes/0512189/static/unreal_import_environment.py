...
Open a new empty level named MeituanLane0512189, then run from Unreal Python:
...
import unreal
SOURCE_DIR=Path(globals().get('MEITUAN_SOURCE_DIR',r'C:/Users/Administrator/Desktop/accident_data_20260908/environment_reconstruction_0512189'))
NAME='MeituanLane0512189';DEST='/Game/MeituanLane0512189/Assets'
...
unreal.log('Imported {} meshes and {} materials. Add CARLA BaseMap lighting; save level as MeituanLane0512189; attach the OpenDRIVE actor for your CARLA version. Check waypoint overlay before cooking.'.format(meshes,materials))
