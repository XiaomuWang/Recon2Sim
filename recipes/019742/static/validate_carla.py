...
for w in m.generate_waypoints(.5):
 l=w.transform.location;samples.append({'road':w.road_id,'lane':w.lane_id,'s':w.s,'xyz_rh':[l.x,-l.y,l.z],'lane_width':w.lane_width,'heading_rh':-math.radians(w.transform.rotation.yaw)})
jchecks=[]
