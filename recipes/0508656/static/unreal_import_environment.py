...
Open a new empty level named MeituanBrake0508656, then run from Unreal Python:
...
import unreal
SOURCE_DIR=Path(globals().get('MEITUAN_SOURCE_DIR',r'C:/Users/Administrator/Desktop/accident_data_20260908/environment_reconstruction_0508656'))
NAME='MeituanBrake0508656';DEST='/Game/MeituanBrake0508656/Assets'
if not (SOURCE_DIR/(NAME+'.fbx')).is_file():raise RuntimeError('Set MEITUAN_SOURCE_DIR or SOURCE_DIR to the extracted asset folder.')
...
for asset_path in task.imported_object_paths:
 ...
 if isinstance(asset,unreal.StaticMesh):
  ...
  actor=unreal.EditorLevelLibrary.spawn_actor_from_object(asset,unreal.Vector(0,0,0),unreal.Rotator(0,0,0));actor.set_actor_label(label);actor.set_folder_path('MeituanEnvironment/'+category)
...
unreal.log('Imported {} meshes and {} materials. Add CARLA BaseMap lighting; save level as MeituanBrake0508656; attach the OpenDRIVE actor for your CARLA version. Check waypoint overlay before cooking.'.format(meshes,materials))
